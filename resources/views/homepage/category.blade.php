      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <a href="{{ URL::to('kategori/satu') }}" class="text-decoration-none">
            <p class="card-text">paket PC Set 1</p>
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <a href="{{ URL::to('kategori/dua') }}" class="text-decoration-none">
            <p class="card-text">paket PC set 2</p>
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <a href="{{ URL::to('kategori/tiga') }}" class="text-decoration-none">
            <p class="card-text">Paket PC set 3</p>
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('produk/satu') }}">
          <img src="{{asset('images/imac.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('produk/dua') }}">
          <img src="{{asset('images/Macbook.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('produk/tiga') }}">
          <img src="{{asset('images/Ipad.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
